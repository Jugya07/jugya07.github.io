...
export const PROJECTS = [
  ...
  },
  {
    ...
    period: "Coming soon",
    description:
      "A dashboard for monitoring and managing cloud resources across multiple providers. Features include real-time metrics, alerts, and cost optimization tools.",
  ...
  },
  {
    ...
    period: "Coming soon",
    description:
      "A command-line utility for system monitoring and diagnostics. It provides insights into CPU, memory, disk usage, and network performance.",
